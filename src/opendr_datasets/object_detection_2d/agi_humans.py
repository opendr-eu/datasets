...
class AGIHumans(ConcatDataset):
    def __init__(self, root):
        ...
        human_subset = XMLBasedDataset('agi_humans', root, images_dir='human', annotations_dir='human_anot')
        no_human_subset = XMLBasedDataset('agi_humans_negative', root, images_dir='no_human',
